...
var OrderProductStore = /** @class */ (function () {
  ...
  OrderProductStore.prototype.orderProductIndex = function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            err_1 = _a.sent();
            throw new Error(
              'Could not get OrderProductStore. Error: '.concat(err_1)
            );
          case 4:
            return [2 /*return*/];
        }
  ...
  OrderProductStore.prototype.addProductToOrder = function (
    orderId,
    productId
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            err_2 = _a.sent();
            throw new Error(
              'Could not get OrderProductStore. Error: '.concat(err_2)
            );
          case 4:
            return [2 /*return*/];
        }
  ...
  OrderProductStore.prototype.deleteProductFromOrder = function (
    orderId,
    productId
  ) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            err_3 = _a.sent();
            throw new Error(
              'Could not delete product from order. Error: '.concat(err_3)
            );
          case 4:
            return [2 /*return*/];
        }
