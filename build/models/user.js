...
var UserStore = /** @class */ (function () {
  ...
  UserStore.prototype.authenticateUser = function (
    enteredUserId,
    enteredPassword
  ) {
    return __awaiter(this, void 0, void 0, function () {
      var conn, sql, dbUser, user, err_3;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 3, , 4]);
          ...
          case 2:
            ...
            if (dbUser.rows.length) {
              ...
              if (
                ...
                return [
                  2 /*return*/,
                  'You have entered the wrong password, please enter the right password',
                ];
              }
            } else {
              return [
                2 /*return*/,
                'Unknown user name, please create the user first before authenticating.',
              ];
            }
            return [3 /*break*/, 4];
          case 3:
            err_3 = _a.sent();
            throw new Error(
              'Could not authenticate user. Error: '.concat(err_3)
            );
          case 4:
            return [2 /*return*/];
        }
  ...
  UserStore.prototype.createUser = function (user) {
    return __awaiter(this, void 0, void 0, function () {
      var conn, sql, hashedPassword, result, err_4;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 3, , 4]);
          ...
          case 1:
            ...
            hashedPassword = bcrypt_1['default'].hashSync(
              user.password + process.env.PEPPER_STRING,
              parseInt(process.env.SALT_ROUNDS)
            );
            return [
              4 /*yield*/,
              conn.query(sql, [user.firstname, user.lastname, hashedPassword]),
            ];
          case 2:
            result = _a.sent();
            conn.release();
