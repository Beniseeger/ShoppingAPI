...
var OrderStore = /** @class */ (function () {
  function OrderStore() {}
  OrderStore.prototype.getCurrentOrderByUserId = function (userId) {
  ...
  OrderStore.prototype.orderIndexRoute = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            err_3 = _a.sent();
            throw new Error(
              'Could not create new order. Error: '.concat(err_3)
            );
          case 4:
            return [2 /*return*/];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            conn = _a.sent();
            sql =
              'UPDATE orders SET status=($1), quantity=($3) WHERE id=($2) RETURNING *';
