...
var getOrderProductIndexRoute = function (req, res) {
...
var addProductToOrderRoute = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            orderProductStore.addProductToOrder(
              req.params.orderId,
...
var deleteOrderProductRoute = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var user, err_3;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            orderProductStore.deleteProductFromOrder(
              req.params.orderid,
              req.params.productid
            ),
          ];
...
routes.post(
  ...
  tokenHandlerMiddleware_1['default'],
