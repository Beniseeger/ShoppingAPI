...
var showProductRoute = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productStore.getProductById(req.params.id)];
            case 1:
                result = _a.sent();
                res.status(200).json(result);
                return [3 /*break*/, 3];
...
var createProductRoute = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newProduct, result, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var deleteProductRoute = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productStore.deleteProduct(req.body.id)];
            case 1:
                user = _a.sent();
...
routes.post('/delete', tokenHandlerMiddleware_1["default"], deleteProductRoute);
