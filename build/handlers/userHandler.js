...
var userIndexRoute = function (req, res) {
...
var showUserRoute = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var result, err_2;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
var authenticateUserRoute = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            userStore.authenticateUser(req.body.id, req.body.password),
          ];
        case 1:
          user = _a.sent();
